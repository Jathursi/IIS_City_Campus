          ...
          <div className="relative w-full md:w-[90%] lg:w-[80%] flex items-center">
            ...
            >
              ...
              <div className="w-full md:w-2/3 p-4 md:p-6">
                <h2 className="text-xl md:text-2xl font-bold mb-2">{slides[currentIndex].title}</h2>
                <p className="text-gray-600 text-sm md:text-base">{slides[currentIndex].description}</p>
              </div>
            </motion.div>
            <button
